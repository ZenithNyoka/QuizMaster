...
function submit() {
    ...
    if(ans === ""){
        ansInput.style.borderColor = "red";  // highlight input box
        ansInput.focus();                     // focus cursor
        return;                               // stop submission
    }

    // Reset border color if answer provided
...
function finish() {
    ...
    document.getElementById("scoreText").innerText = `${score} / 22`;
